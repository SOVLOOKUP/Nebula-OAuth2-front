...
<main>
	<a href="https://github.com/sovlookup">by SOVLOOKUP</a>
	<canvas></canvas>
	<script>
...
<style>
    ...
    background-image: radial-gradient(circle at center, rgba(81, 68, 154, 0.13), transparent), radial-gradient(circle at center, rgba(41, 196, 255, 0.13), transparent);
	}
